...
import { procStepsData, ProcStepItem } from "../../data/procSteps";

export default function ProcStepsPage() {
  const [selected, setSelected] = useState<ProcStepItem>(
    procStepsData.find((item) => item.id === "proc-sort") || procStepsData[0]
  );
  ...
  const filtered = procStepsData.filter((item) =>
